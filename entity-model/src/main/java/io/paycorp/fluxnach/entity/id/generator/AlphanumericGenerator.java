 ...
 * 
 */
package io.paycorp.fluxnach.entity.id.generator;

import java.io.Serializable;

import io.paycorp.fluxnach.entity.id.service.AbstractStringIdentifierGenerator;
...
implements Serializable {
	...
	/**
	 * Construct with a counter, that will start at the specified alphanumeric
	 * value.</p>
	 * 
	 * @param wrap
	 *            should the factory wrap when it reaches the maximum value (or
	 *            throw an exception)
	 * @param initialValue
	...
	public AlphanumericGenerator(boolean wrap, String initialValue) {
		...
		for (int i = 0; i < this.count.length; i++) {
			...
			throw new IllegalArgumentException("character " + this.count[i]
					+ " is not valid");
		}
	}
	...
	/**
	 * @Method nextNumericIdentifier
	 * @return String
	 * @author rojalinb
	 */
	public synchronized String nextNumericIdentifier() {
		for (int i = count.length - 1; i >= 0; i--) {
			switch (count[i]) {
			case NINE_CHAR: // 9
				if (i == 0 && !wrapping) {
